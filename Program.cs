...
else if (Console.ReadLine () == why)
{
    Console.WriteLine("Hmm. Paranoid, aren't you. At least I know it's working.");
    bool paranoid = true;
}
else
{
...
if (paranoid = true)
{
    Console.WriteLine("Wow, I know your name now. Guess you weren't so paranoid after all.");
    Console.WriteLine("It's a good thing I'm just here to be helpful. ");
}
